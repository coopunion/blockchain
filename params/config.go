...
var (
	MainnetGenesisHash = common.HexToHash("0x97acae6da9feb3b0283477833d2fc2e795732c3fa4599cc97dad39df36fc069f")
	TestnetGenesisHash = common.HexToHash("0x97acae6da9feb3b0283477833d2fc2e795732c3fa4599cc97dad39df36fc069f")
)
...
var (
	...
	// AllThemisProtocolChanges copies from AllCliqueProtocolChanges.
	AllThemisProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, &ThemisConfig{Period: 0, Epoch: 30000}}
...
type ChainConfig struct {
	...
	Themis *ThemisConfig `json:"Themis,omitempty"`
}
...
// ThemisConfig is the consensus engine configs for proof-of-stake-authority based sealing.
...
// String implements the stringer interface, returning the consensus engine details.
func (c *ThemisConfig) String() string {
	return "Themis"
}
